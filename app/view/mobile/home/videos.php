...
$uri=$data['static']['uri']?$data['static']['uri']:'/videos';
      ...
      <div class="categories">
        <ul>
          ...
          <li data-ref="presentation11">
            <a href="javascript:void(0)">Video Type <span>0</span></a>
          </li>
      ...
      <div class="tab-content">
          ...
          <div class="search-inner filter-search">
            ...
            <ul class="city select" data-multiple="0">
                <li name="feature_v" class="<?=$tquery['feature_v']=='1'?' active ':''?>" value="1"><a href="javascript:void(0)" data-index="0">Featured Videos</a></li>
                <li name="feature_v" class="<?=$tquery['feature_v']=='2'?' active ':''?>" value="2"><a href="javascript:void(0)" data-index="0">Other videos</a></li>
            </ul>
          </div>
...
<script type="text/javascript">
  ...
  console.log(tquery);
    ...
    $(".btn-reset").click(function() {
      if ('<?=Input::get("search")?>'!='') {
        window.location.href='/videos?search='+'<?=Input::get("search")?>'; 
      }else{
...
$('#videos_id').addClass('activebg-menue');
</script>
